...
# и составляетсписок windows со свободным временем (время переводится в формат h:m)
...
# Вызовем функцию how_much для отсортированного списка времени и на выходе получим список windows
